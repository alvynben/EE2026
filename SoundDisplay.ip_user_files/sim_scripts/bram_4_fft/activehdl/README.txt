...
#
# Generated by export_simulation on Sun Apr 03 17:12:36 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './bram_4_fft.sh' script.

./bram_4_fft.sh -reset_run
...
./bram_4_fft.sh -noclean_files

For more information on the script, please type './bram_4_fft.sh -help'.
