...
HD_PWD='C:/Users/junki/Downloads/Telegram Desktop/incomplete_cockery.xpr/SoundDisplay/SoundDisplay.runs/bram_4_fft_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_4_fft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_4_fft.tcl
